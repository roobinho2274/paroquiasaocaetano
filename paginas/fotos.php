...
<html lang="pt-br">
	<head>
		...
		<script type="text/javascript" >
			//função javascript para os slides do Pagina 
			$(function (){
				$("#slides ul").cycle ({
					fx: 'scrollLeft',//efeito da mudança de foto
					speed: 2000,//tempo de transição
					timeout: 4000,//tempo para mudança de foto 
					prev: '#anterior',
					next: '#proximo',
				})
			});
	...
	<body>
		...
		<nav>
			<ul class="cabecalho">
				...
				<li><a href="paginas/linksCabecalho/mensagemDia.html">Mensagem do Dia</a></li>
		...
		<!--Pagina de Galeria de Fotos da paroquia-->
		<div id="corpo">
			<!--Criação de Sliders para as fotos da paroquia-->
			<div id="slides">
				<ul>
					<li ><img src="../img/SANTANA.jpg" id="imgSlides"/></li>
					<li ><img src="" id="imgSlides"/></li>
					<li ><img src="" id="imgSlides"/></li>
					<li ><img src="" id="imgSlides"/></li>
				</ul>
			</div>
				<a href="#" id="anterior" ><img src="../img/esq.png"></a>
				<a href="#" id="proximo"><img src="../img/dir.png"></a>
		</div>
		<div id="rodape">
