...
<html lang="pt-br">
	...
	<body>
		...
		<div id="corpo">
        	<h2>Sistema das noticias</h2>
            	</h3>Selecione uma das opções abaixo:</h3></br>
				<a href="cadastro.php">Inserir uma nova noticia;</a></br>
				<a href="consulta.php">Consultar uma noticia;</a></br>
				<a href="alterar.php">Editar uma noticia;</a></br>
				<a href="excluir.php">Excluir uma noticia;</a></br>
		</br>
		</div>
		<div id="rodape">
