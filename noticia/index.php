...
<html lang="pt-br">
	...
	<body>
		...
		<nav>
			<ul class="menu">
				<li><a href="../index.html">A Paróquia</a>
					<ul >
						<li><a href="../paginas/historia.html">História</a></li>
						<li><a href="../paginas/paroco.html">Administrador Paroquial</a></li>
						...
						<li><a href="../paginas/comunicados.html">Comunicados</a></li>
					</ul>
				</li>
				<li><a href="../index.html">Comunidades</a>
					<ul>
				...
				<li><a href="../index.html">Pastorais</a>
					<ul>
				...
				<li><a href="../index.html">Movimentos</a>
					<ul>
				...
				<li><a href="../index.html">Ministérios</a>
					<ul>
						...
						<li><a href="../paginas/ministerios/salmista.html">Salmistas</a></li>
		...
		<nav>
			<ul class="cabecalho">
				...
				<li><a href="../paginas/linksCabecalho/reflexao.html">Mensagem do Dia</a></li>
				<li><a href="../paginas/linksCabecalho/evangelhoDia.html">Evangelho do Dia</a></li>
		...
		<div id="corpo">
		<!-- Pagina de Inserção de Dados na pagina de noticias-->
			<h2>Inserção de Dados/Alteração das Paginas</h2>
			<form enctype="multipart/form-data" action="upload.php" method="post">
				<h3>Selecione uma opção:</h3>
				<input id="criar" type ="radio" value ="criar" name ="noticiaOpcao">Criar noticia;</br>
				<input id="editar" type ="radio" value ="editar" name ="noticiaOpcao">Editar noticia;</br>
				<input id="consultar" type ="radio" value ="consultar" name ="noticiaOpcao">Pesquisar noticia;</br>
				<input id="excluir" type ="radio" value ="excluir" name ="noticiaOpcao">Excluir noticia</br>
			</form>
		</div>
		<div id="rodape">
